...
class Stream:
    ...
    def __init__(self, stream, addr, port=0, buff_size=0, stream_id=None, shared_key=None, isDebug=False, aud_params=None, pcm_queue=None, sink_muted=None, sink_volume=None):
